    ...
    return (
        <div className="flex flex-col items-center text-center space-y-4 p-4">
            ...
            <div className="flex justify-center gap-4 mt-4 w-full">
                <button
                    onClick={onCancel}
                    className="w-full sm:w-1/2 py-2 bg-gray-200 text-gray-700 rounded-full border border-gray-400 hover:bg-gray-300 transition"
                >
                    {t("CANCEL") || "Cancel"}
                </button>
                <button
                    ...
                    onClick={onConfirm}
                    className="w-full sm:w-1/2 py-2 bg-red-600 text-white rounded-full hover:bg-red-700 transition"
                >
