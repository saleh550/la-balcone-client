...
interface UnPublishCategoryFormProps {
    onConfirm: () => void;
    onCancel: () => void;
    isUnPublishLoading: boolean
}

const UnPublishCategoryForm: React.FC<UnPublishCategoryFormProps> = ({
    onConfirm,
    onCancel,
    isUnPublishLoading
}) => {
    ...
    return (
        <div className="flex flex-col items-center text-center space-y-4 p-4">
            ...
            <h2 className="text-xl font-semibold text-gray-800">
                {t("UNPUBLISH_CATEGORY_TITLE") || "UnPublish Category"}
            </h2>

            {/* Description */}
            <p className="text-gray-600 text-sm">
                {t("UNPUBLISH_CATEGORY_QUESTION") ||
                    `Are you sure you want to UnPublish "${getName(currentLanguage, deletingCategory)}"? This action cannot be undone.`}
            </p>
...
export default UnPublishCategoryForm;
