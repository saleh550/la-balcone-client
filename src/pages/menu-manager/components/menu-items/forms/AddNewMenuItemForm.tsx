...
interface AddMenuItemFormProps {
    setIsAddMenuItemModalOpen: Dispatch<SetStateAction<boolean>>
}
const AddNewMenuItemForm: React.FC<AddMenuItemFormProps> = ({ setIsAddMenuItemModalOpen }) => {
    const { subCategories, addMenuItemToSubCategory } = useMenuManager()
    ...
    const onSubmit = async (data: MenuItemFormData) => {
        ...
        await addNewMenuItem(formData, addMenuItemToSubCategory, setIsAddMenuItemModalOpen, setIsLoading)
        // await addNewMenuItem(formData, addMenuItem, setIsLoading, setIsAddMenuItemModalOpen)
    };
        ...
        <div className="max-w-lg mx-auto bg-transparent p-6 rounded-2xl ">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                <div>
                    ...
                    <SelectInput name="subCategoryId" options={subCategories} register={register} error={errors.subCategoryId} />
                </div>
